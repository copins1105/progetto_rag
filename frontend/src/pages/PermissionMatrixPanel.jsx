...
// src/pages/PermissionMatrixPanel.jsx — RESPONSIVE
// Mobile: category filters scroll horizontally, table scrolls, header stacks
// Fixed overlapping: save button + search no longer overflow on small screens
...
const CAT_COLORS = {
  ...
  "Utenti":    { bg: "rgba(245,158,11,0.08)",  accent: "#f59e0b", border: "rgba(245,158,11,0.2)"  },
  "Log":       { bg: "rgba(239,68,68,0.08)",   accent: "#ef4444", border: "rgba(239,68,68,0.2)"   },
  "Chat":      { bg: "rgba(20,184,166,0.08)",  accent: "#14b82a", border: "rgba(20,184,72,0.2)"   },
};
...
function PermCell({ effettivo, hasPending, pendingValue, onClick }) {
  ...
  return (
    <button
      ...
      title={displayed ? "Revoca" : "Assegna"}
      style={{
        width: 32, height: 28, borderRadius: 6, cursor: "pointer",
        border: hasPending
          ? `2px dashed ${displayed ? "rgba(52,211,153,0.8)" : "rgba(107,114,128,0.6)"}`
...
function CategorySection({ catName, codici, tuttiPermessi, utenti, localChanges, handleCellClick, aperta, onToggle }) {
  ...
  return (
    <div style={{
      background: "var(--surface)", border: `1px solid ${catColor.border}`,
      ...
      <button
        ...
        style={{
          ...
          padding: "9px 16px",
          background: catColor.bg, border: "none", cursor: "pointer",
          textAlign: "left",
        ...
        <span style={{ fontSize: "0.72rem", color: catColor.accent, marginLeft: 6 }}>
          {aperta ? "▾" : "▸"}
        </span>
      </button>

      {aperta && (
        /* Always horizontal scroll — table can overflow on any screen */
        <div style={{ overflowX: "auto", WebkitOverflowScrolling: "touch" }}>
          <table style={{
            borderCollapse: "collapse",
            width: "100%",
            minWidth: `${200 + presenti.length * 72}px`,
          }}>
            <thead>
              <tr style={{ background: "var(--surface2)" }}>
                <th style={{
                  padding: "7px 14px", textAlign: "left", whiteSpace: "nowrap",
                  borderBottom: "1px solid var(--border)", width: 200, minWidth: 180,
                  ...
                  <tr key={utente.utente_id} style={{
                    ...
                    <td style={{
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                        ...
                        <div>
                          <div style={{
                            fontSize: "0.75rem", fontWeight: 600, color: "var(--text)", lineHeight: 1.2,
                          }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            fontFamily: "'DM Mono', monospace", padding: "2px 7px",
        ...
        <div style={{
          ...
          {[
            { label: "Assegnato", text: "✓", assigned: true, pending: false },
            { label: "Non assegnato", text: "—", assigned: false, pending: false },
            { label: "Non salvato", text: "✓", assigned: true, pending: true },
          ].map((item, i) => (
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 5 }}>
              <span style={{
                ...
                background: item.assigned ? "rgba(52,211,153,0.12)" : "transparent",
                color: item.assigned ? "#34d399" : "var(--border-strong)",
        ...
        {saveMsg && (
          <div style={{
            ...
            fontSize: "0.75rem",
            background: saveMsg.ok ? "rgba(52,211,153,0.1)" : "rgba(239,68,68,0.1)",
            border: `1px solid ${saveMsg.ok ? "rgba(52,211,153,0.3)" : "rgba(239,68,68,0.3)"}`,
